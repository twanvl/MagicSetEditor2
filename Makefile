...
am_magicseteditor_OBJECTS = ./src/render/text/viewer.$(OBJEXT) \
	...
	./src/gfx/polynomial.$(OBJEXT) ./src/gfx/blend_image.$(OBJEXT) \
	...
	./src/gui/value/image.$(OBJEXT) ./src/gui/value/text.$(OBJEXT) \
	...
	./src/gui/icon_menu.$(OBJEXT) ./src/gui/new_window.$(OBJEXT) \
	...
	./src/script/parser.$(OBJEXT) ./src/data/field/color.$(OBJEXT) \
	...
	./src/data/format/image_to_symbol.$(OBJEXT) \
	...
	./src/util/action_stack.$(OBJEXT) ./src/util/string.$(OBJEXT) \
	./src/util/alignment.$(OBJEXT) ./src/util/version.$(OBJEXT) \
	./src/util/error.$(OBJEXT) ./src/util/age.$(OBJEXT) \
...
magicseteditor_SOURCES = ./src/render/text/viewer.cpp \
	...
	./src/render/text/font.cpp ./src/render/text/element.cpp \
	./src/render/symbol/viewer.cpp ./src/render/symbol/filter.cpp \
	./src/render/card/viewer.cpp ./src/render/value/color.cpp \
	...
	./src/gui/set/cards_panel.cpp ./src/gui/set/stats_panel.cpp \
	./src/gui/symbol/select_editor.cpp \
	./src/gui/symbol/point_editor.cpp ./src/gui/symbol/control.cpp \
	./src/gui/symbol/part_list.cpp ./src/gui/symbol/editor.cpp \
	./src/gui/symbol/basic_shape_editor.cpp \
	./src/gui/symbol/window.cpp ./src/gui/value/color.cpp \
...
mostlyclean-compile:
	...
	-rm -f ./src/data/format/image_to_symbol.$(OBJEXT)
...
include ./src/data/format/$(DEPDIR)/image_to_symbol.Po
